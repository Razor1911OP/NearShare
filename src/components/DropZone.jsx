        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              background:   'radial-gradient(ellipse at 50% 0%, rgba(88,166,255,0.22) 0%, transparent 70%)',
              boxShadow:    '0 0 48px rgba(88,166,255,0.28)',
              opacity:      glowSpring,
              pointerEvents:'none',
              zIndex:       0,
            }}
          ...
          <motion.div
            animate={{
              ...
              background:  isDragging ? 'rgba(88,166,255,0.055)' : 'rgba(255,255,255,0.018)',
              borderColor: isDragging ? 'rgba(88,166,255,0.80)' : 'rgba(255,255,255,0.13)',
            }}
              ...
              {isDragging && (
                <motion.div
                  ...
                  style={{
                    position:        'absolute',
                    inset:           0,
                    backgroundImage: `radial-gradient(circle, rgba(88,166,255,0.06) 1px, transparent 1px)`,
            ...
            <motion.div
              animate={{
                ...
                boxShadow: isDragging
                  ? '0 0 56px rgba(88,166,255,0.60), 0 0 24px rgba(188,140,255,0.30)'
                  : '0 0 28px rgba(88,166,255,0.30)',
              }}
