...
function Pill({ tone = 'muted', children }) {
  const styles = {
    muted: { background: 'rgba(255,255,255,0.05)', color: 'var(--text-2)', border: '1px solid var(--border)' },
    good:  { background: 'rgba(63,185,80,0.12)', color: 'var(--good)', border: '1px solid rgba(63,185,80,0.30)' },
    bad:   { background: 'rgba(248,81,73,0.12)', color: 'var(--bad)', border: '1px solid rgba(248,81,73,0.30)' },
    warn:  { background: 'rgba(210,153,34,0.12)', color: 'var(--warn)', border: '1px solid rgba(210,153,34,0.30)' },
    brand: { background: 'rgba(88,166,255,0.12)', color: 'var(--brand)', border: '1px solid rgba(88,166,255,0.30)' },
  }[tone]
  return (
    <span
      style={{
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${bad ? 'rgba(248,81,73,0.35)' : 'var(--border)'}`,
        minWidth: 0,
      }}
    >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: 'var(--text-2)', fontSize: '0.9rem' }}>
              <span
                style={{
                  ...
                  height: 18,
                  borderRadius: '50%',
                  border: '2.5px solid rgba(88,166,255,0.20)',
                          ...
                          {status === 'testing' ? (
                            <span
                              style={{
                                ...
                                height: 14,
                                borderRadius: '50%',
                                border: '2px solid rgba(88,166,255,0.20)',
                                borderTopColor: 'var(--brand)',
                                animation: 'ns-spin 0.7s linear infinite',
                              }}
                            />
