    ...
    <>
      ...
      <AnimatePresence>
        {phase === 'idle' && (
          ...
          >
            <motion.div
              whileHover={{ scale: 1.04, boxShadow: '0 12px 36px rgba(88,166,255,0.35)' }}
              whileTap={{ scale: 0.97 }}
              className="ns-card"
              style={{
                display:    'flex',
                ...
                gap:        12,
                padding:    '11px 20px',
                background: 'linear-gradient(135deg, rgba(88,166,255,0.16) 0%, rgba(188,140,255,0.13) 100%)',
                border:     '1px solid rgba(88,166,255,0.32)',
                boxShadow:  '0 6px 24px rgba(88,166,255,0.18)',
              }}
            >
        ...
        {isPressing && (
          ...
          >
            <svg width={160} height={8}>
              <rect width={160} height={8} rx={4} fill="rgba(88,166,255,0.12)" />
              <motion.rect
                height={8} rx={4}
                fill="var(--brand)"
                initial={{ width: 0 }}
          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                zIndex:      84,
                pointerEvents:'none',
                filter:      `drop-shadow(0 18px 40px rgba(88,166,255,${nearTop ? 0.55 : 0.35}))`,
                willChange:  'transform',
              }}
            >
              <div style={{
                background:     'linear-gradient(145deg, rgba(22,34,56,0.98), rgba(14,22,40,0.98))',
                border:         `1.5px solid rgba(88,166,255,${nearTop ? 0.75 : 0.45})`,
                borderRadius:   18,
                padding:        '16px 20px',
                display:        'flex',
                ...
                boxShadow:      nearTop
                  ? '0 0 0 1px rgba(88,166,255,0.25), inset 0 1px 0 rgba(255,255,255,0.08)'
                ...
                <div style={{
                  ...
                  padding:        '3px 10px',
                  borderRadius:   999,
                  background:     nearTop ? 'rgba(88,166,255,0.22)' : 'rgba(88,166,255,0.10)',
        ...
        {phase === 'releasing' && dragResult === 'sent' && (
          ...
          >
            <div style={{
              ...
              boxShadow:      '0 8px 40px rgba(63,185,80,0.25)',
            }}>
        ...
        <>
          ...
          >
            <div style={{
              ...
              padding:        '10px 22px',
              borderRadius:   999,
              background:     'rgba(19,29,46,0.96)',
              border:         '1px solid rgba(88,166,255,0.36)',
              backdropFilter: 'blur(24px)',
              WebkitBackdropFilter: 'blur(24px)',
              boxShadow:      '0 8px 36px rgba(88,166,255,0.22)',
              fontSize:       '0.92rem',
              fontWeight:     600,
              color:          'var(--text)',
            }}>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                inset:       -36,
                borderRadius:'50%',
                background:  'radial-gradient(circle, rgba(88,166,255,0.38) 0%, rgba(188,140,255,0.18) 40%, transparent 70%)',
                pointerEvents:'none',
                filter:      'blur(2px)',
              }}
            />
            ...
            <motion.div
              ...
              style={{
                background:     'linear-gradient(145deg, rgba(22,34,56,0.98), rgba(14,22,40,0.97))',
                ...
                boxShadow:      [
                  '0 10px 50px rgba(88,166,255,0.35)',
