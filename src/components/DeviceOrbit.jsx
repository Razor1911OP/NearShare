...
function DeviceNode({ device, index, total, isSelected, isPulsing, onSelect }) {
  ...
  const ringColor   = isPulsing  ? 'rgba(88,166,255,0.90)'
                    : isSelected ? 'rgba(88,166,255,0.72)'
                    : online     ? 'rgba(63,185,80,0.48)'
                    :              'rgba(255,255,255,0.10)'

  const glowShadow  = isPulsing
    ? '0 0 0 4px rgba(88,166,255,0.25), 0 0 28px rgba(88,166,255,0.55)'
    : isSelected
    ? '0 0 0 3px rgba(88,166,255,0.18), 0 0 18px rgba(88,166,255,0.30)'
    : online
    ? '0 0 0 2px rgba(63,185,80,0.12), 0 0 12px rgba(63,185,80,0.20)'
    : 'none'

  const nodeBg = online
    ? 'linear-gradient(145deg, rgba(28,42,64,0.95) 0%, rgba(16,26,46,0.95) 100%)'
    : 'rgba(16,22,36,0.75)'
...
export default function DeviceOrbit() {
  ...
  const { devices, selectedTargetId, incomingDrag } = state
    ...
    >
      ...
      >
          ...
          {deviceList.map((device, i) => {
            ...
            return (
              <motion.line
                ...
                x2={pos.x}  y2={pos.y}
                stroke={
                  isActive ? 'rgba(88,166,255,0.60)'
                  : isSel  ? 'rgba(88,166,255,0.35)'
        ...
        <motion.button
          ...
          whileHover={{
            scale:     1.08,
            boxShadow: '0 0 0 10px rgba(88,166,255,0.12), 0 0 40px rgba(88,166,255,0.40)',
          }}
          whileTap={{ scale: 0.94 }}
          style={{
            position:       'absolute',
            ...
            gap:            2,
            zIndex:         5,
            boxShadow:      '0 0 0 6px rgba(88,166,255,0.10), 0 0 26px rgba(88,166,255,0.28)',
